...
def main():
    print("=" * 80)
    print(" 🚀 CREATING AND PUSHING 9 TARGET REPOSITORIES TO @mdyasar49")
    print("=" * 80)
    ...
    print("\n" + "=" * 80)
    print(" 📊 MIGRATION SUMMARY (9 TARGET PROJECTS)")
    print("=" * 80)
    for repo_name, success in status_summary:
        icon = "✅ Pushed & Active" if success else "⚠️ Created on GitHub"
