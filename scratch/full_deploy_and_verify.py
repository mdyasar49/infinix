...
ssh_api.connect('209.182.232.150', username='infogenx-api', password='infogenx-api@1234', timeout=15)
...
ssh_cand.connect('209.182.232.150', username='infogenx-candidates', password='infogenx@1234', timeout=15)
